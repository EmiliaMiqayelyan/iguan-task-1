...
function LoginModal({show, hideModal}) {
  ...
  const handleChange = (value) => {
    ...
    special.test(value) ? setSpecialValidated(true) : setSpecialValidated(false);
                ...
                <div className="login-right-part">
                    ...
                    <div className="login-input-part">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input type="text" placeholder="Email or Username" className="login-input" {...register("email", { required: true, pattern: regex })} 
                        ...
                        {!error && 
                            ...
                            <div>
                              <button className="login-btn" onSubmit={data => console.log(data)}>Log in now</button>
                            </div>
                        </form>
                    </div>
                    <div>
                    ...
                    <div className="login-close-btn">
                      <button className="close-btn" onClick={() => hideModal()}><AiOutlineClose /></button>
                  </div>
              </div>
            </div>
        </Modal.Body>
